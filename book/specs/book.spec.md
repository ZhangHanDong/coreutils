...
- 全书目标为 80,000-110,000 个中文字符；正文每章为 3,500-5,500 个中文字符。
- 每个正文章包含 `> **定位**`、至少三处一手证据引用、至少一张 Mermaid 图、模式提炼、实践清单、局限以及 `### 版本演化说明`。
...
场景: 正文章节满足证据与结构契约
  ...
  假设 "16" 个正文章均已写完
  当 质量脚本逐章检查内容
  那么 每章存在定位块、Mermaid 图、至少 "3" 处证据引用和版本演化说明
  并且 每章字符数位于 "3500" 到 "5500" 之间
