...
- **E2-ORIENTATION**：[`CONTRIBUTING.md:29-51`](https://github.com/uutils/coreutils/blob/d8bee62c1ddc227d5e4385d80bbf6d7dee266a41/CONTRIBUTING.md#L29-L51) 与 [`Cargo.toml:375-395`](https://github.com/uutils/coreutils/blob/d8bee62c1ddc227d5e4385d80bbf6d7dee266a41/Cargo.toml#L375-L395)，utility、`uucore`、测试、multicall、fuzz 与 root workspace 边界。
...
- **E2-STATIC-GATES**：[`DEVELOPMENT.md:53-88`](https://github.com/uutils/coreutils/blob/d8bee62c1ddc227d5e4385d80bbf6d7dee266a41/DEVELOPMENT.md#L53-L88)、[`.pre-commit-config.yaml:47-69`](https://github.com/uutils/coreutils/blob/d8bee62c1ddc227d5e4385d80bbf6d7dee266a41/.pre-commit-config.yaml#L47-L69) 与 [`.github/workflows/code-quality.yml`](https://github.com/uutils/coreutils/blob/d8bee62c1ddc227d5e4385d80bbf6d7dee266a41/.github/workflows/code-quality.yml)，本地/CI 的 Clippy、rustfmt、Cargo.lock 与 target matrix。
- **E2-DENY**：[`deny.toml:3-126`](https://github.com/uutils/coreutils/blob/d8bee62c1ddc227d5e4385d80bbf6d7dee266a41/deny.toml#L3-L126) 与 [`.github/workflows/audit.yml`](https://github.com/uutils/coreutils/blob/d8bee62c1ddc227d5e4385d80bbf6d7dee266a41/.github/workflows/audit.yml)，advisory、license、duplicate、source policy 与定时 RustSec 入口。
- **E2-TEST-COMMANDS**：[`DEVELOPMENT.md:111-195`](https://github.com/uutils/coreutils/blob/d8bee62c1ddc227d5e4385d80bbf6d7dee266a41/DEVELOPMENT.md#L111-L195)、[`tests/uutests/src/lib/util.rs`](https://github.com/uutils/coreutils/blob/d8bee62c1ddc227d5e4385d80bbf6d7dee266a41/tests/uutests/src/lib/util.rs)、[`test_date.rs`](https://github.com/uutils/coreutils/blob/d8bee62c1ddc227d5e4385d80bbf6d7dee266a41/tests/by-util/test_date.rs) 与 [`test_cp.rs`](https://github.com/uutils/coreutils/blob/d8bee62c1ddc227d5e4385d80bbf6d7dee266a41/tests/by-util/test_cp.rs)，测试选择、字节结果、隔离夹具、环境与副作用样例。
...
- **E2-UUFUZZ-TARGETS**：固定提交的 [`fuzz/Cargo.toml:48-160`](https://github.com/uutils/coreutils/blob/d8bee62c1ddc227d5e4385d80bbf6d7dee266a41/fuzz/Cargo.toml#L48-L160) 及 `fuzz_date.rs`、`fuzz_echo.rs`、`fuzz_sort.rs`、`fuzz_non_utf8_paths.rs`，证明各 target 的注册、生成、执行与比较策略不同。
...
- **E3-KNOWN-RISKS**：[Ubuntu 26.04 LTS changes since 25.10](https://documentation.ubuntu.com/release-notes/26.04/changes-since-previous-interim/)；`published_at=unknown`、`last_updated_at=2026-05-06`、`verified_at=2026-08-14`。范围：26.04 相对 25.10；ACL 条目也适用于 25.10，漏洞清单的“This release”仅指 26.04。
...
- **E4-RUST-SKELETON**：以入口、平台数据、共享机制、错误出口和副作用边界组织 Rust 迁移骨架。
...
- **provider**：在部署系统中提供实际命令或默认实现的软件包/实现方。
- **artifact provenance**：连接二进制、commit、构建、依赖、签名与 rollout 配置的来源链。
...
- **stateful shadow**：候选处理代表输入，但只写隔离 sink、事务影子、快照或独立命名空间；禁止写共享生产状态。
- **run ID**：标识固定基线、命令、环境、时间和结果的一次验证执行。
- **seed**：可重放差异或性质失败的最小输入及环境/fixture。
...
|---|---|---|---|
| 问题重定义、成功边界 | [第 1 章](../part1/ch01-behavior-reconstruction.md) | 第 2、3 章 | 前言、附录 A |
| Behavior Contract / oracle | [第 3 章](../part1/ch03-behavior-contract.md) | 第 8—10 章 | 附录 B、A |
| Context Boundary / Manifest | [第 4 章](../part2/ch04-clean-room.md) | 第 12、16 章 | 附录 C |
| Rust 接缝、共享层 | [第 5 章](../part2/ch05-rust-skeleton.md) | 第 7、11 章 | 附录 D、A 轨迹二 |
| Agent Atomicity / Task Contract | [第 6 章](../part2/ch06-agent-atomicity.md) | 第 12、13 章 | 附录 B |
| 静态门禁与测试层级 | [第 7 章](../part3/ch07-static-gates.md) | 第 8—10 章 | 附录 E L1/L2 |
| 差分、fuzz、回归捕获 | [第 9 章](../part3/ch09-differential-testing.md) | 第 10、12 章 | 附录 A 轨迹一/三 |
| 人类审查、AI 责任 | [第 11 章](../part4/ch11-human-owns-change.md) | 第 12、16 章 | 附录 E |
| Change Package | [第 12 章](../part4/ch12-change-package.md) | 第 13、16 章 | 附录 A、E |
| DoD Profile | [第 13 章](../part4/ch13-definition-of-done.md)（规范接口） | 第 14—16 章 | 附录 D、E（引用接口） |
| Shadow / canary / kill switch | [第 14 章](../part5/ch14-rollout-rollback.md) | 第 15、16 章 | 附录 A 轨迹三 |
| Ubuntu 生产边界 | [第 15 章](../part5/ch15-ubuntu-boundaries.md) | 第 14、16 章方法解释 | 本附录 E3 |
| 十阶段流水线、30/60/90 | [第 16 章](../part5/ch16-pipeline.md) | 全书回流 | 附录 A 全部轨迹 |
...
- `E3-MIGRATION-DESIGN`：第 14、15 章；25.10 发行前状态与正式发行事件由第 15 章直接链接的一手页面分栏，不能互换。
