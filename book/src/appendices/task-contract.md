...
behavior_contract_ref:
  ...
  id: "BC-MIG-UTILITY-001"
  version: 1
  object_hash: "sha256:canonical-contract"
...
`behavior_contract_ref` 必须指向第 3 章完整 `behavior-contract/v1`，其中七字段 `K=(I,O,X,S,E,P,U)` 与 `non_goals` 必填；Task Contract 只复述意图和控制边界，不另造契约 schema。二进制输出、路径字节和 locale 文本不能未经论证转成 UTF-8；副作用要覆盖内容、权限、链接、时间戳和失败后状态，未知进入 `U`。
...
behavior_contract_ref: {schema: "behavior-contract/v1", id: "BC-LOCAL-021", version: 1, object_hash: "sha256:bc-local-021"}
context_boundary:
...
behavior_contract_ref: {schema: "behavior-contract/v1", id: "BC-SHARED-008", version: 1, object_hash: "sha256:bc-shared-008"}
context_boundary:
...
behavior_contract_ref: {schema: "behavior-contract/v1", id: "BC-DELETE-003", version: 1, object_hash: "sha256:bc-delete-003"}
context_boundary:
