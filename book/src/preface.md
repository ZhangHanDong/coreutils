...
- **系统迁移路径**：从[第 1 章](part1/ch01-behavior-reconstruction.md)顺读至[第 16 章](part5/ch16-pipeline.md)，由问题重定义进入生产发布。
- **AI 治理路径**：读[第 4 章](part2/ch04-clean-room.md)、[第 6 章](part2/ch06-agent-atomicity.md)、[第 11—13 章](part4/ch11-human-owns-change.md)与[第 16 章](part5/ch16-pipeline.md)，再用[附录 B—E](appendices/task-contract.md)落库。
- **验证工程路径**：由[第 3 章](part1/ch03-behavior-contract.md)进入[第 7—10 章](part3/ch07-static-gates.md)，最后到[第 14 章](part5/ch14-rollout-rollback.md)，把契约变成门禁、反例与回滚触发器。
