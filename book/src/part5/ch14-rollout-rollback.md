...
> **定位**：本章将已批准变更从仓库带入生产环境。前置依赖是[第 13 章合并 DoD](../part4/ch13-definition-of-done.md)与[第 12 章变更包](../part4/ch12-change-package.md)；输出是每阶段都有准入、观察窗口、扩展决策与回退阈值的渐进发布路径，并把生产反例交给[第 15 章](ch15-ubuntu-boundaries.md)校准。
